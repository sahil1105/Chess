...
/**
 * Rook -- Extension of the ChessPiece class. Used to represent a rook object in a game of Chess.
 * @author sahil1105
 */
public class Rook extends ChessPiece{

    /**
     Constructor for the Rook class. Simply calls the constructor for the ChessPiece class.
     * @param pos The position piece is at on the Board.
     * @param player1 Whether or not the piece belongs to player 1.
     */
    public Rook(@NotNull int[] pos, boolean player1) {
        super(pos, player1);
    }
    ...
    public List getPossibleMoves(@NotNull Board gameBoard) {
        ...
        //check the possible directions the rook can move in, which are horizontally and vertically on the board
    ...
    /**
     * Overriding toString function for the Rook class.
     * @return String representation of the Rook class. Capital if belongs to player 1, uncapitalized otherwise.
     */
    @Override
    public String toString() {
        return this.player1? " R": " r";
    }
